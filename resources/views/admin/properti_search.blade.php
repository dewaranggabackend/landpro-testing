...
<table class="table table-bordered" id="datatablesSimple">
    ...
    ?></td>
        ...
        <td><a href="/properti/{{$properti->id}}/off" onclick="return confirm('Apakah kamu yakin?')"><button class="btn btn-danger" data-toggle="tooltip" title="Move to Trash"><i class="fa fa-trash"></i></button></a>
