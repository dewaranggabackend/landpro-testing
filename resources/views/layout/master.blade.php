<!DOCTYPE html>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <img src="/landpro.png" width=30px height=30px>
            Landpro</a>
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
            <div class="ms-auto me-0 me-md-3 my-2 my-md-0">
                <a href="#"><i class="fab fa-facebook oranye"></i></a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <i class="fa fa-envelope-open-text"></i> &nbsp;    Voucher
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/voucher">Aktif</a>
                                    <a class="nav-link" href="/voucher/kadaluwarsa">Kadaluwarsa</a>
        </nav>
        </div>

                            <div class="sb-sidenav-menu-heading">LAINNYA</div>
                            <a class="nav-link" href="/privacy">
                            <i class="fa fa-user-secret"></i> &nbsp;    Kebijakan Privasi
                            </a>
                            <a class="nav-link" href="/syarat">
                            <i class="fa fa-user-cog"></i> &nbsp;    Syarat Penggunaan
                            </a>
                            <a class="nav-link" href="/tentang">
                            <i class="fa fa-address-card"></i> &nbsp;    Tentang Kami
                            </a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Landpro 2021</div>
                        </div>
                    </div>
                </footer>
            </div>
