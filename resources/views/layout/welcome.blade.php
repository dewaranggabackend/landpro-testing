...
<html lang="en">
    <head>
        ...
        <style>
            ...
            */
            ...
            .bg-image {
                background-image: url('/wallpaper-contrast.png');
            }
            .outer-g {
               color: #fff;
            }
    ...
    <body id="page-top" style="background-image: url('/wallpaper-contrast.png'); background-repeat: no-repeat; background-size: cover;">
